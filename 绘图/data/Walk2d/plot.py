...
def get_args():
    ...
    parser.add_argument('--color', type=str, nargs='*', default=['#ff7f0e','#008080', '#3357FF', '#FF33A1']) #'#cc3311', '#0077bb'
    parser.add_argument('--labels', type=str, nargs='*', default=['H2O', 'PAR_BC', 'SAC_BC', 'SAC_CQL'])
    parser.add_argument('--title', type=str, default='Walkerd2-footjint-medium')
...
if __name__ == '__main__':
    ...
    for (folder, color) in zip(args.folders, args.color):
        ...
        test_rew = ea.scalars.Items('test/target_return')
